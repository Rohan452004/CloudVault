    ...
    <nav className="w-full flex items-center justify-between px-8 py-4 bg-white/80 backdrop-blur border-b border-blue-100 shadow-md sticky top-0 z-30">
      ...
      >
        <svg className="w-8 h-8 text-blue-500" fill="none" viewBox="0 0 32 32">
          ...
          />
          <path
            d="M24 18a6 6 0 10-11.75-1.75A4 4 0 008 22h16a4 4 0 000-8z"
            fill="#3B82F6"
            fillOpacity="0.3"
          />
          <ellipse
      ...
      <div className="flex gap-4 items-center">
        <a
          href="#storage-mode"
          className="text-blue-600 font-semibold px-4 py-2 rounded-lg border border-blue-200 hover:bg-blue-50 transition"
        >
          Choose Storage Mode
        </a>
        ...
        {!user ? (
          <>
            <Link
              to="/auth/login"
              className="text-blue-700 font-semibold px-3 py-1 rounded hover:bg-blue-50 transition"
            >
              Login
            </Link>
            <Link
